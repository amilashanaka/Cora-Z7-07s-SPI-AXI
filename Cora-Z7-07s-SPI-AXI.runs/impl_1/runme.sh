...
HD_PWD='C:/Projects/ERN24004/Projects/Cora-Z7-07s-SPI-AXI/Cora-Z7-07s-SPI-AXI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axispi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axispi_wrapper.tcl -notrace
