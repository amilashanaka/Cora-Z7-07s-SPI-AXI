...
HD_PWD='C:/Projects/ERN24004/Projects/Cora-Z7-07s-SPI-AXI/Cora-Z7-07s-SPI-AXI.runs/axispi_spi_axi_lite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axispi_spi_axi_lite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axispi_spi_axi_lite_0_0.tcl
