...
HD_PWD='C:/Projects/ERN24004/Projects/Cora-Z7-07s-SPI-AXI/Cora-Z7-07s-SPI-AXI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axispi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axispi_wrapper.tcl
